...
pub mod ll {
    ...
    extern "C" {
        ...
        pub fn clCreateContext(properties: *const cl_context_properties,
                               ...
                               pfn_notify: extern "C" fn(*const libc::c_char,
                                                         *const libc::c_void,
                                                         libc::size_t,
                                                         *mut libc::c_void),
        ...
        pub fn clCreateContextFromType(properties: *mut cl_context_properties,
                                       device_type: cl_device_type,
                                       pfn_notify: extern "C" fn(*mut libc::c_char,
                                                                 *mut libc::c_void,
                                                                 libc::size_t,
                                                                 *mut libc::c_void),
                                       user_data: *mut libc::c_void,
        ...
        pub fn clBuildProgram(program: cl_program,
                              ...
                              pfn_notify: extern "C" fn(cl_program, *mut libc::c_void),
                              user_data: *mut libc::c_void)
                              -> cl_int;
        ...
        pub fn clSetEventCallback(event: cl_event,
                                  ...
                                  pfn_notify: extern "C" fn(cl_event, cl_int, *mut libc::c_void),
                                  user_data: *mut libc::c_void)
                                  -> cl_int;
